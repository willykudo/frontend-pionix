...
const AttendanceDetail = ({ attendance, onClose, fetchAttendances }) => {
    ...
    useEffect(() => {
        ...
        if (attendance) {
            ...
            setPreviewCheckInImage(`https://backend-pionix.onrender.com/${attendance.checkInImage}`);
            setPreviewCheckOutImage(`https://backend-pionix.onrender.com/${attendance.checkOutImage}`);
        }
    }, [attendance]);
